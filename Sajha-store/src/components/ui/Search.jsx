    ...
    >
      ...
      <div className="w-10/12 flex items-stretch">
        <input
          ...
          className="text-sm font-sans text-gray-800 py-2 px-4  w-full bg-white outline-0 border border-orange-600 rounded-l-full focus:shadow-[inset_0_0_5px_rgba(249,115,22,0.4)]"
          value={searchTerm}
          onChange={(e) => {
        ...
        />
        <button
          className="cursor-pointer text-[14px] text-white border border-orange-600 bg-orange-600 rounded-r-full px-4 py-1"
      ...
      {searchTerm && (
        <MdClear
          size={25}
          className="absolute text-gray-800 right-28 cursor-pointer hover:bg-[rgba(0,0,0,0.2)] hover:rounded-full"
          onClick={handleClear}
        />
      )}
        ...
        <div className="absolute w-10/12 mx-auto mt-1 top-[90%] left-0 right-0 z-50 bg-white border-gray-100 shadow-lg rounded-md ">
          {suggestions.map((item) => (
            <div
              ...
              className="p-2 hover:bg-gray-100 cursor-pointer border-b border-gray-100 last:border-b-0 font-sans font-thin"
            >
