            ...
            </NavLink>
            {
                isAuthenticated ? (
                    <div className="flex items-center justify-center gap-1 font-sans p-2 -m-2 group relative">
                        ...
                        group-hover:opacity-100 group-hover:visible transition-opacity z-50 py-2 rounded 
                        whitespace-nowrap bg-white shadow-md">
                            <div className="flex gap-2 flex-col items-center justify-center 
                            font-thin w-full">
                                <NavLink to="/profile" className="w-full">
                                    <p className="flex gap-2 items-center justify-center hover:bg-gray-100
                                cursor-pointer px-3 py-1 w-full" ><CgProfile className="text-gray-600" />
                                        <span className="text-sm font-sans">Profile</span></p>
                                </NavLink>

                                <NavLink to="/orders" className="w-full">
                                    <p className="flex gap-2 items-center justify-center hover:bg-gray-100
                                cursor-pointer px-3 py-1 w-full" ><RiOrderPlayLine className="text-gray-600" />
                                        <span className="text-sm font-sans">Orders</span></p>
                                </NavLink>

                                <p className="flex gap-2 items-center justify-center hover:bg-gray-100
                                cursor-pointer px-3 py-1 w-full" onClick={logout}><RiLogoutCircleLine className="text-gray-600" />
                                    <span className="text-sm font-sans">Logout</span></p>
                            </div>
                        </div>
