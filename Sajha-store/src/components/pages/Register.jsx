        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-8">
            ...
            <div className="lg:col-span-5 space-y-2 md:space-y-3">
              <h2 className="text-orange-500 text-sm md:text-lg font-medium">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  <label
                    htmlFor="firstname"
                    className="font-sans text-sm text-gray-800 mb-1"
                  >
                    First Name:
                  </label>
                  <input
                    ...
                    className={`px-3 py-2.5 font-sans text-sm border gray-400 ${
                      formData.firstname === ""
                        ? "border-orange-500 "
                        : "border-gray-400 "
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    className={`px-3 py-2.5 font-sans text-sm border rounded outline-0 ${
                      !formData.lastname
                        ? "border-orange-500"
                        : "border-gray-400 "
                    } focus:ring-1 focus:ring-orange-200 transition-all duration-200`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    className={`px-3 py-2.5 font-sans text-sm border rounded outline-0 ${
                      !formData.email ? "border-orange-500" : "border-gray-400 "
                    } focus:ring-1 focus:ring-orange-200 transition-all duration-200`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  <label
                    htmlFor="password"
                    className="font-sans text-gray-800 text-sm mb-1"
                  >
                    Password:
                  </label>
                  <div className="relative">
                    <input
                      ...
                      name="password"
                      id="password"
                      className={`w-full px-3 py-2.5 font-sans text-sm border  rounded outline-0 ${
                        !formData.password
                          ? "border-orange-500"
                          : "border-gray-400"
                      } focus:ring-1 focus:ring-orange-200 transition-all duration-200 pr-10`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    id="country"
                    placeholder="Country"
                    className={`px-3 py-2.5 font-sans text-sm border ${
                      !formData.country
                        ? "border-orange-500"
                        : "border-gray-400"
                    } rounded outline-0 focus:ring-1 focus:ring-orange-200 transition-all duration-200`}
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    className={`px-3 py-2.5 font-sans text-sm border ${
                      !formData.state ? "border-orange-500" : "border-gray-400"
                    } rounded outline-0 focus:ring-1 focus:ring-orange-200 transition-all duration-200`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    placeholder="City"
                    className={`px-3 py-2.5 font-sans text-sm border ${
                      !formData.city ? "border-orange-500" : "border-gray-400"
                    } rounded outline-0 focus:ring-1 focus:ring-orange-200 transition-all duration-200`}
                    value={formData.city}
                    onChange={handleChange}
                  />
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    className={`px-3 py-2.5 font-sans text-sm border ${
                      !formData.street ? "border-orange-500" : "border-gray-400"
                    } rounded outline-0 focus:ring-1 focus:ring-orange-200 transition-all duration-200`}
          ...
          <div className="flex items-center mt-2">
            ...
            <label
              htmlFor="terms"
              className="ml-2 text-sm font-sans text-gray-700"
            >
              I agree to all the{" "}
          ...
          <div className="text-center pt-4">
            <button
              className="w-full md:w-auto bg-orange-600 hover:bg-orange-500 text-white font-medium py-3 px-8 rounded transition-all duration-300 ease-in-out transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 cursor-pointer"
