...
const Home = () => {
  ...
  return (
    <section className="relative py-5 min-h-lvh w-11/12 mx-auto mb-12">
      <div className=" h-[60vh] flex items-center justify-center bg-gray-100 rounded">
        <div className="relative flex items-center gap-15 w-10/12">
          <div className="">
            <p className="text-[15px] text-blue-800 font-sans leading-0">
              Welcome to
            </p>
            <h1 className="text-5xl text-gray-800 font-bold leading-15 font-sans">
              Sajha Store
            </h1>
            <p className="text-[16px] font-light font-sans">
              Quality products for every corner of your life, with prices that
              make sense.
            </p>
            <NavLink to="/product">
              <button
                className="bg-orange-600 text-[15px] hover:bg-orange-500 mt-5 
      ...
      <div className="mt-10">
        ...
        <div className=" shadow-[0_0_2px_rgba(0,0,0,0.3)] rounded relative">
          ...
          <div
            ref={boxRef}
            className="flex gap-3 overflow-x-hidden p-3 scroll-smooth bg-white"
          >
            {product
