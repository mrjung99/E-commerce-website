                ...
                <div className='mt-8 space-y-4'>
                    <form action="" className='space-y-4'>
                        <div className='flex flex-col'>
                            ...
                            <input type="email" placeholder='Email...' name='email' id='email' className='bg-gray-100 px-3 py-2 font-sans font-thin text-sm border border-orange-600 focus:shadow-[inset_0_0_4px_rgba(249,115,22,0.4)] rounded outline-0' />
                        </div>
                        <div className='flex flex-col'>
                            <label htmlFor="password" className='text-gray-700 text-sm'>Password:</label>
                            <div className='relative'>
                                <input type="password" placeholder='Password...' name='password' id='password' className='w-full bg-gray-100 px-3 py-2 font-sans font-thin text-sm border border-orange-600 focus:shadow-[inset_0_0_4px_rgba(249,115,22,0.4)] rounded outline-0' />
                        ...
                        <div className='flex gap-15 items-center text-[13px]'>
                        ...
                        <button className='bg-orange-600 hover:bg-orange-500 text-gray-100 font-sans py-1 px-4 rounded cursor-pointer mt-2 w-full transition-all duration-300 ease'>Log In</button>
                    </form>
                    <div className='font-sans text-[13px] text-gray-700'>
