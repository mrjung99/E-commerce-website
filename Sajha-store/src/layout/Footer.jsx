...
const Footer = () => {
    return (
        <section className=' bg-gray-800 text-gray-100'>
            <div className='grid grid-cols-12 gap-4 justify-between p-4'>
                ...
                <div className='col-span-2 space-y-3 font-sans p-8'>
                    ...
                    <div className='font-thin text-[12px] flex flex-col'>
                        ...
                        <span className='cursor-pointer hover:text-orange-400 w-fit'>Our Store</span>
                        <span className='cursor-pointer hover:text-orange-400 w-fit'>FAQ</span>
                        <span className='cursor-pointer hover:text-orange-400 w-fit'>Store location</span>
                    </div>
                </div>
                <div className='col-span-2 space-y-3 font-sans p-8'>
                    ...
                    <div className='text-[12px] font-thin flex flex-col'>
                        ...
                        <span className='cursor-pointer hover:text-orange-400 w-fit'>Activewear</span>
                        <span className='cursor-pointer hover:text-orange-400 w-fit'>Popular Trends</span>
                        <span className='cursor-pointer hover:text-orange-400 w-fit'>Store location</span>
                    </div>
                </div>
            ...
            <div className='flex justify-between items-center font-sans py-5 px-12'>
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <div className='flex gap-3 font-sans font-thin text-[12px]'>
                        ...
                        <span className='hover:text-orange-400 cursor-pointer transition-all duration-300'>Shpping policy</span>
                        <span className='hover:text-orange-400 cursor-pointer transition-all duration-300'>Contact information</span>
                    </div>
                </div>
            </div>
        </section>
